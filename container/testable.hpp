...
public:
  ...
  bool operator==(const TestableContainer<Data>& other) const noexcept = delete; // Comparison of abstract types is not possible.
  bool operator!=(const TestableContainer<Data>& other) const noexcept = delete; // Comparison of abstract types is not possible.
  ...
  virtual bool Exists(const Data& value) const noexcept = 0; // (concrete function should not throw exceptions)
